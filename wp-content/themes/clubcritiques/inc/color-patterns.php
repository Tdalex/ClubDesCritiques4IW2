 ...
 */
function clubcritiques_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Club Critiques default saturation level.
	 *
	 * @since Club Critiques 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'clubcritiques_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.clubcritiques-front-page) .entry-title,
...
.colors-custom .clubcritiques-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.clubcritiques-front-page .panel-content .recent-posts article,
...
.colors-custom.clubcritiques-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Club Critiques custom colors CSS.
	 *
	 * @since Club Critiques 1.0
	 *
	 ...
	 */
	return apply_filters( 'clubcritiques_custom_colors_css', $css, $hue, $saturation );
}
