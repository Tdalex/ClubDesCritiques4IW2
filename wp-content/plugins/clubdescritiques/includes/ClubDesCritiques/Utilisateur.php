...
class Utilisateur{
	...
	public static function modifyUserInfo($request){
		...
		if($lastEmail != $request['email']){
			$object    = 'Modification de votre email';
			$message   = 'Bonjour,<br><br>Votre email vient d\'êtres modifié, En cas de problème veuillez nous contacter au plus tôt,<br> sinon veuillez ignorer ce message.<br> Cordialement, <br><BR> Le club des critiques';
			$headers[] = 'From: '. NO_REPLY;
